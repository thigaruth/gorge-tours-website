  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button:
          'h-8 w-8 bg-background border border-border rounded-full p-0 opacity-90 hover:opacity-100 inline-flex items-center justify-center',
        ...
        day_today: 'bg-accent/15 text-accent',
